...
namespace Repository.Migrations
{
    ...
    [Migration("20240725203532_CreatedProjectTables")]
    partial class CreatedProjectTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.MinSystemRequirement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MinSystemRequirements");
                });
            ...
            modelBuilder.Entity("Domain.Entities.News", b =>
                {
                    ...
                    b.Property<string>("NewsMainImage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.RecomSystemRequirement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RecomSystemRequirements");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MinSystemRequirement", b =>
                {
                    b.HasOne("Domain.Entities.Product", "Product")
                        .WithMany("MinSystemRequirements")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.RecomSystemRequirement", b =>
                {
                    b.HasOne("Domain.Entities.Product", "Product")
                        .WithMany("RecomSystemRequirements")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.Navigation("MinSystemRequirements");

                    b.Navigation("ProductImages");

                    b.Navigation("ProductTypes");

                    b.Navigation("RecomSystemRequirements");
