...
namespace Service.Services.Interfaces
{
    public interface IProductService
    {
        ...
        Task<ProductPaginateDto> GetAllPaginatedProducts(int page, string sortType,string searchText, List<string> priceFilters, List<string> genreFilters, List<string> typeFilters, int take = 12);
        Task<int> GetCount();
